...
st.set_page_config(page_title="Cardiovascular Risk Prediction", page_icon="❤️", layout="wide")
...
# Lottie Animation
lottie_health = load_lottieurl("https://assets3.lottiefiles.com/packages/lf20_5njp3vgg.json")

col1, col2 = st.columns([2, 1])

with col1:
    st.title("❤️ Cardiovascular Risk Prediction")
    st.write("Enter your health information to predict your 10-year cardiovascular disease risk.")
...
new_data = {
    'age': age, 'sex': sex, 'cigsPerDay': cigsPerDay, 'BPMeds': BPMeds,
    'prevalentStroke': prevalentStroke, 'prevalentHyp': prevalentHyp, 'diabetes': diabetes,
    'totChol': totChol, 'BMI': BMI, 'heartRate': heartRate, 'glucose': glucose,
    'education_1.0': education_dict[education][0], 'education_2.0': education_dict[education][1],
    'education_3.0': education_dict[education][2], 'education_4.0': education_dict[education][3],
...
# Footer
st.markdown("---")
st.warning("Note: This tool provides an estimate and should not replace professional medical advice.")
